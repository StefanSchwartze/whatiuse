...
export default class LoginPage extends React.Component {
  ...
  render() {
    ...
    <div className="container startpage">
      <div className="">
        <h1 className="pagetitle"><i className="fa fa-clock-o left"></i>Title.</h1>
        ...
        <button className="button show startTracking" onClick={this.register.bind(this)}>Create account</button>
        <button className="button show" onClick={this.login.bind(this)}>Sign in</button>
      </div>
    </div>
    );
  }
